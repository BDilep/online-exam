...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">badugus18@gmail.com</a><br /><br />
...
<a href="#blank" target="_blank">All the Best</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">About Me</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Dilep Badugu" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#blank" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Dilep Badugu</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9392961339</h4>
		<h4 style="font-family:'typo' ">badugus18@gmail.com</h4>
		<h4 style="font-family:'typo' ">Avanthi Institute of Engineering and Technology Hyderabad</h4></div></div>
		</p>
      </div>
